...
export interface IFileTypeRendererProps extends IFieldRendererProps {
    /**
     * file/document path
     */
    path: string;
 ...
 * For future
 */
export interface IFileTypeRendererState {
 ...
 *   - File/Document Type
 */
export default class FileTypeRenderer extends React.Component<IFileTypeRendererProps, IFileTypeRendererState> {
    public constructor(props: IFileTypeRendererProps, state: IFileTypeRendererState) {
        super(props, state);
